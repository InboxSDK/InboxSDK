...
InboxSDK.load(2, 'simple-example')
  .then((sdk) => {
    window.__sdk = sdk;
    ...
    sdk.Compose.registerComposeViewHandler((composeView) => {
      const button = composeView.addButton({
        ...
        onClick(event) {
          event.dropdown.el.innerHTML =
            '<div class="test__dropdownContent">foo</div>';
        },
        section: 'TRAY_LEFT',
      });
      ...
      composeView.on('presending', ({ cancel }) => {
        if (
          composeView.getBodyElement().textContent.indexOf('cancel send') > -1
        ) {
          cancel();
        }
    ...
    const arrowIconUrl =
      'data:image/png;base64,';
      ...
      return [
        {
          ...
          descriptionHTML:
            '<span class="test__suggestionDesc">The description for the third test result</span>',
          onClick() {
