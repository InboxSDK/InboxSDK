...
var insertHTMLatCursor = ud.defn(module, function insertHTMLatCursor(
  element: HTMLElement,
  html: string,
  oldRange: ?Object
): ?HTMLElement {
  ...
  if (element instanceof HTMLTextAreaElement) {
    ...
    if ((element: any).selectionStart < (element: any).selectionEnd) {
      element.value =
        element.value.substring(0, (element: any).selectionStart) +
        element.value.substring((element: any).selectionEnd);
    }
