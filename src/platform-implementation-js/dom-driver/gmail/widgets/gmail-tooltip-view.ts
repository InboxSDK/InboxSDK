...
export default class GmailTooltipView {
  ...
  anchor(anchorElement: HTMLElement, placementOptions: Record<string, any>) {
    if (!anchorElement) {
      return;
    }
  ...
  _setupElement(options: Record<string, any>) {
    ...
    if (options.el) {
      ...
      let html = [
        ...
        '<div class="T-P-Jz-UR">',
        '<div class="aRM" tabindex="0">',
        '<div class="aVn inboxsdk__tooltip_image">', //image goes here
        '</div>',
        '<div class="aRR">',
        ...
        '</div>',
        '<div class="inboxsdk__tooltip_button">', //button goes here
        '</div>',
        '</div>',
        '</div>',
