...
class GmailCollapsibleSectionView {
  ...
  setCollapsibleSectionDescriptorProperty(
    collapsibleSectionDescriptorProperty: Kefir.Observable<?Object>
  ) {
  ...
  _recollapse(children: Array<Object>) {
    children.forEach(child => {
      ...
      (readdEvent: any).initCustomEvent(
  ...
  _createCollapsedContainer() {
    ...
    const element = this._element;
    if (element)
      (element: any).insertAdjacentElement('afterend', collapsedContainer);
  }
