...
document.body.innerHTML = '<div role="banner"><div id="slot"></div></div>';
const slot = document.getElementById('slot');
if (!slot) throw new Error();
const driver = {
  getUserEmailAddress: _.constant('cowan@streak.com'),
} as Driver;
...
`;
  ...
  it('delegated signed in, plus two normal', async () => {
    slot.innerHTML = `
