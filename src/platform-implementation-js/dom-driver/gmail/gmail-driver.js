...
class GmailDriver {
  ...
  getXhrInterceptorStream(): Kefir.Observable<Object> {
  ...
  addAppMenuItem(appId: string, menuItemDescriptor: AppMenuItemDescriptor) {
    return addAppMenuItem(this, appId, menuItemDescriptor);
  }
  ...
  createTopMessageBarDriver(
    optionStream: Kefir.Observable<?Object>
