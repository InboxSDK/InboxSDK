...
const pageParserOptions: PageParserTreeOptions = {
  ...
  finders: {
    ...
    nativeDrawer: {
      fn(root) {
        const drawerUploadFilesBtn = root.querySelector(
          'div[jsaction="global.exit_full_screen"] div[role=dialog][aria-busy=true] div[role=link][jsaction$=".open_local_file_picker"]'
        );
    ...
    appToolbarLocation: {
      ...
      fn(root) {
        ...
        const appToolbarLocation = chatToggle
    ...
    inlineCompose: {
      fn(root) {
        const inlineComposesByPopoutBtn = Array.prototype.filter
          .call(
  ...
  watchers: [
    ...
    },
    {
      ...
      selectors: [
        ...
        '*',
        { $or: [['[role=main]'], [':not([role])', '*', '[role=main]']] },
        '[role=application]',
        '[role=list]',
        '*',
        '*',
        ...
        '[jsvs]',
        {
          $map(el) {
            ...
            const buttonEl = el.querySelector(
              'div[jsaction="global.none"] > div[role=button]'
            );
    ...
    },
    {
      ...
      selectors: [
        ...
        {
          $map(el) {
            const composeEl = el.querySelector(
              'div[role=dialog]:not(.inboxsdk__mole_view)'
            );
            if (!composeEl) {
