...
it('handles regular draft save with recipients', () => {
  ...
  expect(composeRequest).toMatchObject({
    ...
    subject: 'new draft',
    to: [
      { emailAddress: 'test+to@gmail.com', name: null },
      { emailAddress: 'test+to2@gmail.com', name: 'test to2' },
    ],
    cc: [
      { emailAddress: 'test+cc@gmail.com', name: null },
      { emailAddress: 'test+cc2@gmail.com', name: 'test cc2' },
    ],
    bcc: [
      { emailAddress: 'test+bcc@gmail.com', name: null },
      { emailAddress: 'test+bcc2@gmail.com', name: 'test bcc2' },
    ],
  });
});
...
it('handles sending', () => {
  ...
  expect(composeRequest).toMatchObject({
    ...
    draftID: 'r-5205311597211900881',
    subject: 'new draft',
    to: [{ emailAddress: 'test+to@test.com', name: null }],
    cc: null,
    bcc: null,
  });
});
