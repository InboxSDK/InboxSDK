 ...
 */
var GmailSupportItemView = /** @lends GmailSupportItemView */ {
  /**
...
/**
 * @class
 * This type is accepted by the {Global.addSupportItem()} method to insert a{GmailSupportItemView}
 ...
 * Support item view also supports arrow key up/down navigation same as other Gmail support items in the menu and on Enter key press down it fires the onClick call back provided.
 */
var SupportItemDescriptor = /** @lends GmailSupportItemView */ {
  /**
