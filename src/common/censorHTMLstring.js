...
export const ATTRIBUTE_WHITELIST: Set<string> = new Set([
  ...
  "contenteditable",
  "aria-expanded", "aria-hidden", "aria-disabled", "aria-haspopup", "aria-labelledby", "aria-busy", "aria-multiselectable",
  // inbox props
  "data-action-data", "data-item-id", "data-msg-id", "data-map-id",
