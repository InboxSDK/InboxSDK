...
function finder(documentElement: HTMLHtmlElement) {
  return Array.from(
    pageParserOptions.finders.attachmentCard.fn(documentElement)
  );
}
...
describe('Inbox Attachment Card Detection', () => {
  describe('finder', () => {
    it('2016-08-10 message with attachments', () => {
      const attachment1 = querySelector(
        page20160810_2(),
        '[data-test-id=attachment1]'
      );
      const attachment2 = querySelector(
        page20160810_2(),
        '[data-test-id=attachment2]'
      );
      const attachment3 = querySelector(
        page20160810_2(),
        '[data-test-id=attachment3]'
      );
      const attachment4 = querySelector(
        page20160810_2(),
        '[data-test-id=attachment4]'
      );
      const attachment5 = querySelector(
        page20160810_2(),
        '[data-test-id=attachment5]'
      );
  ...
  describe('parser', () => {
    it('2016-08-10 message with attachments', () => {
      {
        const results = parser(
          querySelector(page20160810_2(), '[data-test-id=attachment1]')
        );
      ...
      {
        const results = parser(
          querySelector(page20160810_2(), '[data-test-id=attachment2]')
        );
        expect(results.errors).toEqual([]);
        expect(results.score).toBe(1);
      }
      {
        const results = parser(
          querySelector(page20160810_2(), '[data-test-id=attachment3]')
        );
        expect(results.errors).toEqual([]);
        expect(results.score).toBe(1);
      }
      {
        const results = parser(
          querySelector(page20160810_2(), '[data-test-id=attachment4]')
        );
        expect(results.errors).toEqual([]);
        expect(results.score).toBe(1);
      }
      {
        const results = parser(
          querySelector(page20160810_2(), '[data-test-id=attachment5]')
        );
        expect(results.errors).toEqual([]);
        expect(results.score).toBe(1);
      }
    ...
    it('2016-08-12 list with card', () => {
      const results = parser(
        querySelector(page20160812(), '[data-test-id=attachment1]')
      );
      expect(results.errors).toEqual([]);
      expect(results.score).toBe(1);
    });
    ...
    it('2016-08-16 message with attachment', () => {
      const results = parser(
        querySelector(page20160816(), '[data-test-id=attachment1]')
      );
      expect(results.errors).toEqual([]);
      expect(results.score).toBe(1);
    });
    ...
    it('2016-09-08 card in bundle', () => {
      const results = parser(
        querySelector(page20160908(), '[data-test-id=attachment1]')
      );
      expect(results.errors).toEqual([]);
      expect(results.score).toBe(1);
    });
