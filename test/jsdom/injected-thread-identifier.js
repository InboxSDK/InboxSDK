...
const threadIdentifier = require('../../src/injected-js/thread-identifier');
const PageCommunicator = require('../../src/platform-implementation-js/dom-driver/gmail/gmail-page-communicator');
